...
import { exterior1, exterior2, interior } from '@/lib/images';
        ...
        <div className="w-full lg:w-[45%] flex flex-col gap-4">
          <div>
            ...
            <p className="text-md md:text-base mt-2 text-center lg:text-left">
              We make renting easy with verified listings, smart search filters,
              and a seamless booking process. Find a home that fits your
              lifestyle—quick, secure, and hassle-free!
            </p>
          </div>
